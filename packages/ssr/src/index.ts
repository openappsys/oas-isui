/**
 * OAS-ISUI 服务端渲染（SSR）渲染器 —— `renderToString`。
 *
 ...
 *
 * 为什么按需装载（而不是 `import('@oas-isui/ui')` 全量）：
 * - 全量入口会求值全部 ~115 个组件目录（每个目录 index.ts 的 define 副作用 + 各自依赖图），
 *   测试环境首次 renderToString 实测约 1.8~3.5s；
 * - 本渲染器按 tag 只动态 import 对应组件目录（如 `@oas-isui/ui/basic/button`），白名单组件
 ...
 * - 为什么不走 `@oas-isui/ui/ssr`（Node-safe 类导出入口）：该入口 re-export 全部组件类，
 *   import 任一具名导出都会求值全部 ~115 个类文件（模块装载量不降，只是不 define）；
 *   单独 `@oas-isui/ui/basic/button/oas-button` 子路径与 ui exports 的 `./*` 通配
 ...
 * 不经过 @oas-isui/core/i18n registry——那些模块求值 `class extends HTMLElement` 需要全局
...
import type { Locale } from '@oas-isui/i18n'
...
/**
 * 白名单 tag → 组件目录入口映射（经 @oas-isui/ui exports 的 `./*` 通配可达：
 * `@oas-isui/ui/basic/button` → `dist/basic/button/index.js`，vitest 走 alias 到 src 目录 index.ts）。
...
const TAG_ENTRY: Record<WhiteListTag, string> = {
  ...
  'oas-compact': '@oas-isui/ui/basic/space',
  'oas-empty': '@oas-isui/ui/feedback/empty',
  'oas-divider': '@oas-isui/ui/basic/divider',
  'oas-text': '@oas-isui/ui/basic/typography',
  'oas-title': '@oas-isui/ui/basic/typography',
  'oas-paragraph': '@oas-isui/ui/basic/typography',
  'oas-table': '@oas-isui/ui/data/table',
  'oas-affix': '@oas-isui/ui/layout/affix',
  'oas-ellipsis': '@oas-isui/ui/data/ellipsis',
  'oas-scroll-area': '@oas-isui/ui/floating/scroll-area',
  'oas-tree': '@oas-isui/ui/data/tree',
  'oas-select': '@oas-isui/ui/form/select',
  'oas-input': '@oas-isui/ui/form/input',
  'oas-textarea': '@oas-isui/ui/form/textarea',
  'oas-checkbox': '@oas-isui/ui/form/checkbox',
  'oas-checkbox-group': '@oas-isui/ui/form/checkbox',
  'oas-radio': '@oas-isui/ui/form/radio',
  'oas-radio-group': '@oas-isui/ui/form/radio',
  'oas-switch': '@oas-isui/ui/form/switch',
  'oas-slider': '@oas-isui/ui/form/slider',
  'oas-input-number': '@oas-isui/ui/form/input-number',
  'oas-rate': '@oas-isui/ui/form/rate',
  'oas-auto-complete': '@oas-isui/ui/form/auto-complete',
  'oas-combobox': '@oas-isui/ui/form/combobox',
  'oas-cascader': '@oas-isui/ui/form/cascader',
  'oas-tree-select': '@oas-isui/ui/form/tree-select',
  'oas-mentions': '@oas-isui/ui/form/mentions',
  'oas-date-picker': '@oas-isui/ui/form/date-picker',
  'oas-time-picker': '@oas-isui/ui/form/time-picker',
  'oas-calendar': '@oas-isui/ui/form/calendar',
  'oas-upload': '@oas-isui/ui/form/upload',
  'oas-transfer': '@oas-isui/ui/form/transfer',
  'oas-color-picker': '@oas-isui/ui/form/color-picker',
  'oas-toggle-button': '@oas-isui/ui/form/toggle-button',
  'oas-toggle-group': '@oas-isui/ui/form/toggle-group',
  'oas-pin-input': '@oas-isui/ui/form/pin-input',
  'oas-dynamic-input': '@oas-isui/ui/form/dynamic-input',
  'oas-dynamic-tags': '@oas-isui/ui/form/dynamic-tags',
  'oas-editable': '@oas-isui/ui/form/editable',
  'oas-form': '@oas-isui/ui/form/form',
  'oas-form-item': '@oas-isui/ui/form/form-item',
  'oas-alert': '@oas-isui/ui/feedback/alert',
  'oas-progress': '@oas-isui/ui/feedback/progress',
  'oas-spin': '@oas-isui/ui/feedback/spin',
  'oas-skeleton': '@oas-isui/ui/feedback/skeleton',
  'oas-result': '@oas-isui/ui/feedback/result',
  'oas-backdrop': '@oas-isui/ui/feedback/backdrop',
  'oas-modal': '@oas-isui/ui/feedback/modal',
  'oas-drawer': '@oas-isui/ui/feedback/drawer',
  'oas-popconfirm': '@oas-isui/ui/feedback/popconfirm',
  'oas-card': '@oas-isui/ui/data/card',
  'oas-avatar': '@oas-isui/ui/data/avatar',
  'oas-avatar-group': '@oas-isui/ui/data/avatar-group',
  'oas-image': '@oas-isui/ui/data/image',
  'oas-qrcode': '@oas-isui/ui/data/qrcode',
  'oas-watermark': '@oas-isui/ui/data/watermark',
  'oas-collapse': '@oas-isui/ui/data/collapse',
  'oas-collapse-item': '@oas-isui/ui/data/collapse',
  'oas-descriptions': '@oas-isui/ui/data/descriptions',
  'oas-descriptions-item': '@oas-isui/ui/data/descriptions',
  'oas-timeline': '@oas-isui/ui/data/timeline',
  'oas-timeline-item': '@oas-isui/ui/data/timeline',
  'oas-list': '@oas-isui/ui/data/list',
  'oas-list-item': '@oas-isui/ui/data/list',
  'oas-carousel': '@oas-isui/ui/data/carousel',
  'oas-statistic': '@oas-isui/ui/data/statistic',
  'oas-countdown': '@oas-isui/ui/data/countdown',
  'oas-chart': '@oas-isui/ui/data/chart',
  'oas-code': '@oas-isui/ui/data/code',
  'oas-equation': '@oas-isui/ui/data/equation',
  'oas-log': '@oas-isui/ui/data/log',
  'oas-masonry': '@oas-isui/ui/data/masonry',
  'oas-comment': '@oas-isui/ui/data/comment',
  'oas-marquee': '@oas-isui/ui/data/marquee',
  'oas-number-animation': '@oas-isui/ui/data/number-animation',
  'oas-gradient-text': '@oas-isui/ui/data/gradient-text',
  'oas-aspect-ratio': '@oas-isui/ui/data/aspect-ratio',
  'oas-virtual-list': '@oas-isui/ui/data/virtual-list',
  // —— DSD 批次 4：导航布局组件（layout 多 tag 目录一次装载注册全部） ——
  'oas-tabs': '@oas-isui/ui/layout/tabs',
  'oas-tab-panel': '@oas-isui/ui/layout/tabs',
  'oas-bottom-navigation': '@oas-isui/ui/navigation/bottom-navigation',
  'oas-pagination': '@oas-isui/ui/layout/pagination',
  'oas-steps': '@oas-isui/ui/layout/steps',
  'oas-segmented': '@oas-isui/ui/layout/segmented',
  'oas-breadcrumb': '@oas-isui/ui/navigation/breadcrumb',
  'oas-anchor': '@oas-isui/ui/navigation/anchor',
  'oas-back-top': '@oas-isui/ui/navigation/back-top',
  'oas-menu': '@oas-isui/ui/floating/menu',
  'oas-dropdown': '@oas-isui/ui/floating/dropdown',
  'oas-context-menu': '@oas-isui/ui/floating/contextmenu',
  'oas-menubar': '@oas-isui/ui/floating/menubar',
  'oas-navigation-menu': '@oas-isui/ui/floating/navigation-menu',
  'oas-toolbar': '@oas-isui/ui/floating/toolbar',
  'oas-command': '@oas-isui/ui/floating/command',
  'oas-tour': '@oas-isui/ui/navigation/tour',
  'oas-hover-card': '@oas-isui/ui/floating/hover-card',
  'oas-splitter': '@oas-isui/ui/layout/splitter',
  'oas-flex': '@oas-isui/ui/layout/flex',
  'oas-page-header': '@oas-isui/ui/layout/page-header',
  'oas-float-button': '@oas-isui/ui/layout/float-button',
  'oas-speed-dial': '@oas-isui/ui/floating/speed-dial',
  'oas-layout': '@oas-isui/ui/layout/layout',
  'oas-header': '@oas-isui/ui/layout/layout',
  'oas-sider': '@oas-isui/ui/layout/layout',
  'oas-content': '@oas-isui/ui/layout/layout',
  'oas-footer': '@oas-isui/ui/layout/layout',
  'oas-sidebar': '@oas-isui/ui/layout/sidebar',
  'oas-container': '@oas-isui/ui/layout/container',
  'oas-grid': '@oas-isui/ui/layout/grid',
  'oas-grid-item': '@oas-isui/ui/layout/grid',
  // —— DSD 批次 5：白名单收尾 ——
  'oas-badge': '@oas-isui/ui/basic/badge',
  'oas-button-group': '@oas-isui/ui/basic/button-group',
  'oas-icon': '@oas-isui/ui/basic/icon',
  'oas-kbd': '@oas-isui/ui/basic/kbd',
  'oas-label': '@oas-isui/ui/basic/label',
  'oas-link': '@oas-isui/ui/basic/link',
  'oas-space': '@oas-isui/ui/basic/space',
  'oas-visually-hidden': '@oas-isui/ui/basic/visually-hidden',
  'oas-tooltip': '@oas-isui/ui/floating/tooltip',
  'oas-popover': '@oas-isui/ui/floating/popover',
  'oas-config-provider': '@oas-isui/ui/floating/config-provider',
  'oas-app': '@oas-isui/ui/floating/app',
}
...
function ensureTag(tag: string): Promise<void> {
  ...
  if (!spec) {
    ...
    throw new Error(`[oas-isui/ssr] 未知白名单 tag「${tag}」：无对应组件目录映射`)
  }
...
let i18nApi: typeof import('@oas-isui/i18n') | null = null

/**
 * 装载 i18n registry（纯数据模块，但保持动态 import 以便首次调用时装载，避免无谓的启动开销）。幂等。
 */
async function ensureI18n(): Promise<typeof import('@oas-isui/i18n')> {
  if (!i18nApi) {
    i18nApi = await import('@oas-isui/i18n')
  }
  return i18nApi
}
...
export async function renderToString(
  ...
  if (!(WHITELIST as readonly string[]).includes(tag)) {
    throw new Error(
      `[oas-isui/ssr] 非白名单 tag「${tag}」：renderToString 仅支持 ${WHITELIST.join('、')}，其余组件仍为客户端渲染`,
    )
  }
...
/** registerLocale + setLocale：先注册语言包再按名切换（与 @oas-isui/i18n 约定一致） */
