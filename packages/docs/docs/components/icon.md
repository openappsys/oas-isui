...
```ts
import { checkPath } from '@oas-isui/icons'
import { registerIcon } from '@oas-isui/ui'
...
const cdnScript = `import { registerIconLibrary } from '@oas-isui/ui'
...
const spriteScript = `import { registerIconLibrary } from '@oas-isui/ui'

registerIconLibrary('demo-sprite', {
  resolver: () => '/demo-sprite.svg',
  spriteSheet: true,
})`
const familyScript = `import { registerIconLibrary } from '@oas-isui/ui'

registerIconLibrary('demo-set', {
  resolver: (name, family = 'outline') => \`/demo-set/\${family}/\${name}.svg\`,
})`
const variantScript = `import { registerIconLibrary } from '@oas-isui/ui'
