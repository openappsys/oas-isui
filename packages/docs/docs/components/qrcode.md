...
<DemoBlock title="基础二维码">
  <oas-qrcode value="https://oasisui.dev" aria-label="官网链接二维码"></oas-qrcode>
</DemoBlock>
...
<DemoBlock title="自定义尺寸">
  <div style="width: 100%; display: flex; gap: var(--oas-space-5); align-items: flex-start; flex-wrap: wrap">
    <oas-qrcode value="https://oasisui.dev" size="96" aria-label="小尺寸二维码"></oas-qrcode>
    <oas-qrcode value="https://oasisui.dev" size="160" aria-label="大尺寸二维码"></oas-qrcode>
  </div>
</DemoBlock>
...
<DemoBlock title="error-correction">
  <oas-qrcode value="https://oasisui.dev" error-correction="l" aria-label="L 级纠错二维码"></oas-qrcode>
...
<DemoBlock title="aria-label">
  <oas-qrcode value="https://oasisui.dev" aria-label="商品详情页链接二维码"></oas-qrcode>
  <p style="width: 100%; margin: var(--oas-space-3) 0 0; color: var(--oas-color-text-secondary); font-size: var(--oas-font-size-sm)">
