...
<script type="module">
  import 'https://esm.sh/@oas-isui/ui@1/basic/button'
  import 'https://esm.sh/@oas-isui/ui@1/basic/tag'
</script>
```
...
> Want to see it live? The repo ships a [Playground](https://github.com/openappsys/oas-isui/tree/main/packages/playground) for React / Vue — run `pnpm dev:react` / `pnpm dev:vue` locally.
