...
<DemoBlock title="Download links">
  <oas-link href="/files/oas-isui-guide.pdf" download>Download guide (original filename)</oas-link>
  <oas-link href="/files/oas-isui-guide.pdf" download="oas-guide.pdf" icon="download" icon-position="end">Download guide (custom filename)</oas-link>
</DemoBlock>
