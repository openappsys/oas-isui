...
<DemoBlock title="Link tabs">
  <oas-tabs active="a">
    ...
    <oas-tab-panel label="GitHub" value="b" href="https://github.com/openappsys/oas-isui" target="_blank" rel="noopener"><p>Content 2: external link in a new window.</p></oas-tab-panel>
