      ...
      <div class="hcta-grid">
        ...
        <div class="hcta-term">
          <div class="hcta-term-bar">
            ...
            <span class="hcta-term-file">oas-isui@2.0.0</span>
          </div>
          <div class="hcta-term-body">
            <div><span class="pmt">~/demo</span> <span class="dlr">$</span> <span class="cmd">pnpm add @oas-isui/ui @oas-isui/theme</span></div>
            ...
            <div class="code-line"><span class="kw">import</span> <span class="st">'@oas-isui/theme'</span></div>
            <div class="code-line"><span class="kw">import</span> <span class="st">'@oas-isui/ui'</span></div>
            <div>&nbsp;</div>
...
function goGithub(): void {
  if (typeof window !== 'undefined') window.open('https://github.com/openappsys/oas-isui', '_blank', 'noopener')
}
</script>
