...
const bridges = computed(() =>
  isEn.value
    ? [
        ...
        { ic: 'V', name: 'Vue', hint: '@oas-isui/nuxt', link: '/guide/ssr' },
        { ic: '⚛', name: 'React', hint: '@oas-isui/next', link: '/guide/ssr' },
