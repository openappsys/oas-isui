...
const bridges = computed(() =>
  isEn.value
    ? [
        ...
        { icon: 'gear', name: 'Vue', hint: '@oas-isui/nuxt', link: '/guide/ssr' },
        { icon: 'gear', name: 'React', hint: '@oas-isui/next', link: '/guide/ssr' },
