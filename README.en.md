...
```bash
pnpm add @oas-isui/nuxt   # Nuxt 3 module: isCustomElement + theme injection + SSR helper
pnpm add @oas-isui/next   # Next.js: RSC OasComponent + OasRegistry client registration bootstrap
```

## Documentation

Full component docs and live demos: [oasisui.dev](https://oasisui.dev).

SSR / DSD guide: the [SSR page](https://oasisui.dev/guide/ssr) on the docs site and the `@oas-isui/ssr` package.
