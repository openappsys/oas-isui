 ...
 *   - cdnGzipKB：docs/perf-baseline.json 的 size.packages['@oas-isui/ui'].cdn.gzipBytes（perf:size 产出）
...
const cdnGzipBytes = baseline.size.packages['@oas-isui/ui'].cdn.gzipBytes
...
const perf = {
  ...
  fullEntryKB: toKB(baseline.size.packages['@oas-isui/ui'].fullEntry.gzipBytes),
}
