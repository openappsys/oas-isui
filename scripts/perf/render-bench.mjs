...
await import('@oas-isui/ui/basic/button')
await import('@oas-isui/ui/form/input')
await import('@oas-isui/ui/data/table')
await import('@oas-isui/ui/form/select')
await import('@oas-isui/ui/layout/tabs') // 目录 index 同时 define oas-tabs + oas-tab-panel
await import('@oas-isui/ui/form/form')
await import('@oas-isui/ui/form/form-item')
